    ...
    <div style={{ position: "relative" }}>
      ...
      <article
        ...
        style={{
          ...
          background: ticketBg,
          border: outlineStyle,
          // Standard response-card radius — matches `.card` (theme.ts:244).
          borderRadius: 24,
          padding: "20px 24px",
          textAlign: "left",
              ...
              <span style={{ fontFamily: "Inter, sans-serif", fontSize: 22, fontWeight: 600, color: "currentColor", lineHeight: 1.25 }}>
                <span
                  style={{
                    ...
                    fontStyle: "italic",
                    fontWeight: 500,
                    // Canon yellow on the published ticket only — pops the
                    // "Thoughts on" label against the cream fill while the
                    // variable title completion keeps the chrome color
                    // (navy on public, white on private).
                    color: current.isPublic ? "#dea838" : undefined,
                  }}
                >
                  Thoughts on
                </span>
