  ...
  return (
    ...
    <div style={{ position: "relative", display: "inline-block", opacity: disabled ? 0.6 : 1 }}>
      <button
        ...
        title={isRisky ? "Risky: show redacted stubs (click to reveal)" : hiddenNewReplies > 0 ? "People have written to you from beyond your watch progress. Toggle to \u201crisky\u201d to see them." : "Standard: hide newer comments"}
        disabled={disabled}
        style={{
          display: "inline-flex",
          alignItems: "center",
