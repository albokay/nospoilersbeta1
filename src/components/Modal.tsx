...
export default function Modal({ children, onClose, topContent }: { children: React.ReactNode; onClose: () => void; topContent?: React.ReactNode }) {
  ...
  const modal = (
    <div style={{ position: "fixed", inset: 0, zIndex: 2147483000, display: "grid", placeItems: "center" }}>
      ...
      <div style={{ position: "relative", display: "flex", flexDirection: "column", alignItems: "center", gap: 12, width: "min(820px,92vw)" }}>
        {topContent && (
