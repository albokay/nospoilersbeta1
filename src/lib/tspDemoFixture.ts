...
const INSTRUCTIONAL_ENTRIES: V2RoomFeedEntry[] = [
  ...
  entry({ id: "tsp-gate-1", e: 1, author: U.alborz, isInstructional: true,
    ...
    body: `That's the whole idea of Sidebar. Nothing about an episode reaches you until you've actually seen it. You just reached episode 1, so your friends' episode 1 entries are visible now. Everything written by anyone past here is still sealed.\n\nKeep moving through the episodes one by one for more of this guide.` }),
  ...
  entry({ id: "tsp-gate-4", e: 4, author: U.alborz, isInstructional: true,
    ...
    body: `The map can tell you how your watch progress relates to others'. Maya is still back on episode 2— so anything you write about episode 4 stays hidden from her until she catches up. You don't have to be careful. The spoiler-gate does the work. Write freely; it only opens for people who are ready to read.\n\nTwo more episodes.` }),
